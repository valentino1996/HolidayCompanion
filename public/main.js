        ...
        success: function(data){
            ...
            function agjensia(emri){
                ...
                for(var i=0; i<data[emri]["links"].length; i++){
                    ...
                    str += `<div class="col-xl-3 col-lg-6 col-md-12 col-sm-12 col-12 mr-auto fushat container"><a href="` + data[emri]["links"][i] + `">
                            <img class="images img-fluid rounded img-thumbnail" src="` + data[emri]["img"][i] + `">
